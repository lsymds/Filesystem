...
namespace Baseline.Filesystem.Tests.Adapters.S3.Integration.Directories
{
    public class IterateDirectoryContentsTests : BaseS3AdapterIntegrationTest
    {
        ...
        public async Task It_Iterates_The_Contents_Of_A_Simple_Directory()
        {
            ...
            files.Should().ContainSingle(x => x.NormalisedPath == "simple" && x.FinalPathPartIsObviouslyADirectory);
        ...
        public async Task It_Lists_The_Contents_Of_A_More_Complex_Directory()
        {
            ...
            files.Should().ContainSingle(x => x.NormalisedPath == "a" && x.FinalPathPartIsObviouslyADirectory);
            files.Should().ContainSingle(x => x.NormalisedPath == "a/file.txt");
            files.Should().ContainSingle(x => x.NormalisedPath == "a/another-file.txt");
            files.Should().ContainSingle(x => x.NormalisedPath == "a/b" && x.FinalPathPartIsObviouslyADirectory);
            files.Should().ContainSingle(x => x.NormalisedPath == "a/b/.config");
            files.Should().ContainSingle(x => x.NormalisedPath == "a/b/c" && x.FinalPathPartIsObviouslyADirectory);
            files.Should().ContainSingle(x => x.NormalisedPath == "a/b/c/.keep");
            files.Should().ContainSingle(x => x.NormalisedPath == "a/c" && x.FinalPathPartIsObviouslyADirectory);
            files.Should().ContainSingle(x => x.NormalisedPath == "a/c/d" && x.FinalPathPartIsObviouslyADirectory);
            files.Should().ContainSingle(x => x.NormalisedPath == "a/c/d/e" && x.FinalPathPartIsObviouslyADirectory);
