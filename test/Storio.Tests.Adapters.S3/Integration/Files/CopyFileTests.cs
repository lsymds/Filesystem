...
namespace Storio.Tests.Adapters.S3.Integration.Files
{
    ...
    {
        private static readonly PathRepresentation SourceFilePath = "/a-file/in-the-woods/src.json".AsStorioPath();
        private static readonly PathRepresentation DestinationFilePath = "a-file/in-the-woods/dest.json".AsStorioPath();
